...
<ProfileSidebar
      ...
      {/* Main content with top padding for header and left padding for sidebar on desktop */}
<main className="flex-1 pt-20 md:ml-64 lg:ml-72 px-4 sm:px-6 lg:px-10 py-6 lg:py-8 max-w-6xl w-full">
