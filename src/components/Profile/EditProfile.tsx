        ...
        {!editMode ? (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 mb-4 text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{profile?.availability || "Available for new swaps"}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-3xl shadow-2xl p-8">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-900">Skills I Teach</h3>
                    </div>
                    <div className="flex flex-wrap gap-3">
                      {(profile?.skills || "")
                        ...
                        .map((skill, idx) => {
                          ...
                          return (
                            <div key={idx} className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all">
                              {logo ? (
                                <img src={logo} alt={skill.trim()} className="w-5 h-5 object-contain" />
                              ) : (
                                <div className="w-2 h-2 bg-gray-800 rounded-sm"></div>
                              )}
                              <span className="text-sm font-medium text-gray-800">{skill.trim()}</span>
                            </div>
                          );
                        })}
                      {!(profile?.skills || "").trim() && (
                    ...
                    <div className="flex flex-wrap gap-3">
                      {(profile?.skillsToLearn || "")
                        ...
                        .map((skill, idx) => {
                          const logo = getSkillLogo(skill);
                          return (
                            <div key={idx} className="flex items-center gap-2 px-4 py-2 bg-purple-50 rounded-xl border border-purple-200 hover:border-purple-300 hover:bg-purple-100 transition-all">
                              {logo ? (
                                <img src={logo} alt={skill.trim()} className="w-5 h-5 object-contain" />
                              ) : (
                                <div className="w-2 h-2 bg-purple-600 rounded-sm"></div>
                              )}
                              <span className="text-sm font-medium text-purple-800">{skill.trim()}</span>
                            </div>
                          );
                        })}
                      {!(profile?.skillsToLearn || "").trim() && (
                        <p className="text-gray-500 italic">No skills to learn added yet</p>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <div className="space-y-8">
              ...
              <div>
                <label className="block text-base font-semibold text-gray-900 mb-3">Skills I Teach (comma separated)</label>
                <input
                  type="text"
                  value={skills}
              ...
              <div>
                <label className="block text-base font-semibold text-gray-900 mb-3">Skills I Want to Learn (comma separated)</label>
                <input
                  type="text"
                  value={skillsToLearn}
              ...
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-2">Availability Status</label>
                <select
                  value={availability}
