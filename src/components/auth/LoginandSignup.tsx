        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-10">
          ...
          <div className="flex mb-6">
            <button
              ...
              className={`flex-1 text-xl lg:text-2xl font-bold pb-3 transition-colors ${activeTab === "login" ? "text-blue-900 border-b-4 border-blue-900" : "text-gray-400"}`}
            >
              Login
            </button>
            <button
              onClick={() => { setActiveTab("signup"); setError(""); setSuccess(""); }}
              className={`flex-1 text-xl lg:text-2xl font-bold pb-3 transition-colors ${activeTab === "signup" ? "text-blue-900 border-b-4 border-blue-900" : "text-gray-400"}`}
            >
              SignUp
            </button>
          </div>
          ...
          {activeTab === "signup" && (
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-5 top-1/2 transform -translate-y-1/2">
                  {EyeIcon}
                </button>
              </div>
              ...
              <div className="flex justify-center space-x-4">
                <button className="hover:scale-110 transition-transform" type="button" onClick={handleGoogleLogin}>
                  {/* Google Icon */}
          ...
          {activeTab === "login" && (
            <div className="space-y-4">
              ...
              <div className="text-right">
                <button type="button" onClick={handleForgotPassword} className="text-blue-900 text-xs lg:text-sm hover:underline">
                  Forgot password?
                </button>
              </div>
              <button
